      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-white/80 mb-8 max-w-lg mx-auto lg:mx-0">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="w-72 md:w-80 h-72 md:h-80 bg-white/10 backdrop-blur-sm rounded-3xl p-8 shadow-2xl flex flex-col items-center justify-center">
                ...
                <div className="mt-4 px-4 py-2 bg-amber-400/20 rounded-full">
